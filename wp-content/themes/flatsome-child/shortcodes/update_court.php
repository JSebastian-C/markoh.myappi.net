...
<div class="fake_body">
	<div class="login_form register">
		<form id="form_register">
			...
			<br>
			<input type="text" name="nombre" required placeholder="Nombre" maxlength="100" value="<?= $cancha->nombre ?>">
			<br>
			<br>
			<input type="text" name="direccion" required placeholder="Dirección" maxlength="200" value="<?= $cancha->direccion ?>">
			<br>
			<br>
			<input type="text" name="ciudad" required placeholder="Ciudad" maxlength="50" value="<?= $cancha->ciudad ?>">
			<br>
			<br>
			<input type="text" name="horario" required placeholder="Horario. Ejem: 8:00 pm - 9:00 pm" maxlength="20" value="<?= $cancha->horario ?>">
			<br>
			<br>
			<input type="number" name="telefono" required placeholder="Teléfono. Ejem: 3001234567" maxlength="10" value="<?= $cancha->telefono ?>">
			<br>
			<br>
